...
//			this.field_243284_a = IBidiRenderer.func_243258_a(this.font,this.getTitle().copyRaw().appendSibling(Component.translatable("gui.immersiveindustry.failed_datapack")), this.width - 50);
//	}
