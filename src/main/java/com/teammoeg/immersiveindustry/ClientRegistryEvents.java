...
public class ClientRegistryEvents {
    ...
    public static void onClientSetup(final FMLClientSetupEvent event) {
        ...
        RenderTypeLookup.setRenderLayer(IIContent.IIMultiblocks.crucible, RenderType.cutout());
        RenderTypeLookup.setRenderLayer(IIContent.IIMultiblocks.steam_turbine, RenderType.cutout());
        RenderTypeLookup.setRenderLayer(IIContent.IIBlocks.electrolyzer, RenderType.cutout());
        RenderTypeLookup.setRenderLayer(IIContent.IIMultiblocks.industrial_electrolyzer, RenderType.cutout());
        RenderTypeLookup.setRenderLayer(IIContent.IIMultiblocks.rotary_kiln, RenderType.cutout());
        RenderTypeLookup.setRenderLayer(IIContent.IIMultiblocks.car_kiln, RenderType.cutout());
